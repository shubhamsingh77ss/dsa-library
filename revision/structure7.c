//write a program for passing structure to a function using call by reference
#include<stdio.h>
struct employees
{
...
int main()
{
    ...
    float get_netsalary(struct employees *);//prototype
    float net_sal;
    ...
    net_sal=get_netsalary(&evar);//calling function by refrence
    printf("The Net salary=%8.2f",net_sal);
}
